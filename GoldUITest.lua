...
function library:Watermark(text)
    ...
    edge.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(255, 135, 0)
    ...
    backgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 10, 10)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(28, 28, 28))}
...
function library:Introduction()
    ...
    xsxLogo.Visible = false
    xsxLogo.Image = "nil"
    xsxLogo.ImageColor3 = Color3.fromRGB(255, 135, 0)
    xsxLogo.ImageTransparency = 1
    
    hashLogo.Name = "EJLOGO"
    ...
    hashLogo.Size = UDim2.new(0, 0, 0, 0)
    hashLogo.Visible = false
    hashLogo.Image = "nil"
    hashLogo.ImageColor3 = Color3.fromRGB(255, 135, 0)
...
function library:Init(key)
    ...
    tabButtonsEdge.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
    ...
    containerEdge.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(255, 135, 0)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(255, 135, 0)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(255, 135, 0)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
            ...
            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = Color3.fromRGB(2, 2, 2)}):Play()
            end)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(255, 135, 0)}):Play()
            end)
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleEdge.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
            ...
            toggleDesignGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 135, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 135, 0))}
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybind.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textbox.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(255, 135, 0)}):Play()
                end)

                textBoxValues.FocusLost:Connect(function()
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(2, 2, 2)}):Play()
                end)
            ...
            elseif type == "large" then
                ...
                textBoxValues.Font = Enum.Font.Code
                textBoxValues.PlaceholderColor3 = Color3.fromRGB(255, 255, 255)
                textBoxValues.PlaceholderText = place
                textBoxValues.Text = default
                textBoxValues.TextColor3 = Color3.fromRGB(255, 255, 255)
                textBoxValues.TextSize = 14.000
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            selector.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(255, 135, 0)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(255, 135, 0)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderButton.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 135, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 135, 0))}
